...
public class ToolTipUtils {
    public static String GetSoundName(int variant) {
        String name = switch (variant) {
            ...
            case 1 -> "gui.trainutilities.tooltip.no_sound";
            case 2 -> "gui.trainutilities.tooltip.ice_sound";
            case 3 -> "gui.trainutilities.tooltip.ic2_sound";
            case 4 -> "gui.trainutilities.tooltip.desiro_hc_sound";
            case 5 -> "gui.trainutilities.tooltip.stadlerflirt_sound";
            case 6 -> "gui.trainutilities.tooltip.nyc_subway_sound";
            case 7 -> "gui.trainutilities.tooltip.pkp_ic_sound";
            case 8 -> "gui.trainutilities.tooltip.ic_sound";
            case 9 -> "gui.trainutilities.tooltip.elevator_sound";
            case 10 -> "gui.trainutilities.tooltip.london_1973_stock_soud";
            case 11 -> "gui.trainutilities.tooltip.london_s7_stock_sound";
            case 12 -> "gui.trainutilities.tooltip.london_overground_sound";
            case 13 -> "gui.trainutilities.tooltip.railjet_sound";
            case 14 -> "gui.trainutilities.tooltip.sbahn_sound";
            case 15 -> "gui.trainutilities.tooltip.talent_sound";
